...
<head>
    ...
    <link id="pagestyle" href="{{ asset('Dashboard/css/material-dashboard.css?v=3.0.0') }}" rel="stylesheet" /> 
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ url('/',$page = 'home') }}">
        <img src="{{asset('Dashboard/img/logo-ct.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="me-1 font-weight-bold text-white">Technical Support</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link " href="{{ url('/',$page = 'home') }}">
            ...
            <span class="nav-link-text me-1">المدعوون</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{ url('/',$page = 'reg') }}">
            <div class="text-white text-center ms-2 d-flex align-items-center justify-content-center">
              <i class="material-icons-round opacity-10">table_view</i>
            </div>
            <span class="nav-link-text me-1">المسجلين</span>
          </a>
        </li>
      </ul>
      <form class="nav-link " action="logout" method="post">
            @csrf    
              <button class="nav-link-text me-1" type="submit" style="background:none;border:none;color:#fff"> تسجيل الخروج</button>
      </form>
    </div>
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-primary mt-4 w-100" href="#" type="button">Drgham Z. Dakhol</a>
      </div>
    </div>
</aside>
    @yield('content')
  ...
  <script src="{{ asset('Dashboard/js/sortTable.js') }}"></script>
  <script async defer src="https://buttons.github.io/buttons.js"></script>
  <script src="{{ asset('Dashboard/js/material-dashboard.min.js?v=3.0.0') }}"></script>
</body>
</html>
